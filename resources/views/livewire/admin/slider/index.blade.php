            ...
            <div class="widget-content widget-content-area">
                ...
                <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                    ...
                    <div class="field-wrapper  mb-4" x-data="{isUploading:false,progress:0 }"
                        ...
                        <label for="thumbnail" class="form-label"> تصویر بند انگشتی :
                            <sup style="color: red">*</sup>
                        </label>
                    ...
                    <div class="field-wrapper  mb-4" x-data="{isUploading:false,progress:0 }"
                        ...
                        <label for="story" class="form-label"> اسلایدر  :
                            <sup style="color: red">*</sup>
                        </label>
                                ...
                                <td class="text-center">
                                    <div class="action-btns d-flex align-items-center">
                                        ...
                                        <div class="form-check form-check-success form-check-inline ms-3">
                                            <input wire:confirm="آیا مطمئن هستید؟ با انتخاب شما به عنوان اسلایدر  وبسایت قرار خواهد گرفت !"
